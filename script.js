    ...
    if (moviesData.Search) {
        html = moviesData.Search.map(element => {
            ...
            <div class="card-top"  onclick="showMovieDetails('${element.imdbID}', '${inputValue}')">
                ...
                <img src="${element.Poster=='N/A' ? 'C:\Users\PRAJWAL KENE\.vscode\extensions\backdrop.jpg' : element.Poster}" alt="">
                </div>
...
async function showMovieDetails(itemId, searchInput) {
    ...
    if (movieDetails) {
        ...
        <img src="${movieDetails.Poster =='N/A' ? 'C:\Users\PRAJWAL KENE\.vscode\extensions\backdrop.jpg' : movieDetails.Poster}" alt="">
    </div>
